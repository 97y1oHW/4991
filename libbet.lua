...
--[[
    ...
    RiskColor = Color3.fromRGB(162, 5, 5),
    WarnColor = Color3.fromRGB(255, 183, 14),
]]
...
FontColor = Color3.fromRGB(255, 255, 255);
    ...
    AccentColor = Color3.fromRGB(89,77,201);
...
local targetColor = Toggle.Value and Library.AccentColor or Library.MainColor
    ...
    -- Update the registry
        ...
        if Toggle.Risky then
         ...
         if Toggle.Warn then
            Library:RemoveFromRegistry(ToggleLabel)
            ToggleLabel.TextColor3 = Library.WarnColor
            Library:AddToRegistry(ToggleLabel, { TextColor3 = 'WarnColor' })
        end
...
function Library:CreateWindow(...)
    ...
    if typeof(Config.Position) ~= 'UDim2' then Config.Position = UDim2.fromOffset(180, 50) end
    if type(Config.Size) ~= 'UDim2' then Config.Size = UDim2.fromOffset(600, 630) end
