...
function pages:section(props)
    ...
    local size = props.size or props.Size or props.yaxis or props.yAxis or props.YAxis or props.Yaxis or 200 -- Default height
    side = side:lower()
    -- // variables
    local section = {}
    -- // main
    local sectionholder = utility.new(
        "Frame",
        {
            ...
            BorderMode = "Inset",
            BorderSizePixel = 1,
            Size = UDim2.new(1, 0, 0, size), -- Fixed initial height
            Parent = self[side]
        }
    )
    --
    ...
    local content = utility.new(
        "Frame",
        {
            ...
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Size = UDim2.new(1, -12, 1, -25), -- Adjusted to leave space for title
            Position = UDim2.new(0.5, 0, 1, -5),
            Parent = outline
        }
    )
    --
    local scrollingFrame = utility.new(
        "ScrollingFrame",
        {
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            ...
            Position = UDim2.new(0, 0, 0, 0),
            CanvasSize = UDim2.new(0, 0, 0, 0),
            AutomaticCanvasSize = "Y", -- Dynamically adjust canvas size based on content
            ScrollBarThickness = 5,
            ScrollBarImageColor3 = Color3.fromRGB(56, 56, 56),
            ScrollBarImageTransparency = 0.5,
            ClipsDescendants = true, -- Ensure content is clipped within bounds
    ...
    section = {
        ...
        ["color"] = color,
        ["content"] = content,
        ["scrollingFrame"] = scrollingFrame, -- Reference to the scrolling frame
        ["pointers"] = {}
    }
    --
    local pointer = props.pointer or props.Pointer or props.pointername or props.Pointername or props.PointerName or props.pointerName or nil
